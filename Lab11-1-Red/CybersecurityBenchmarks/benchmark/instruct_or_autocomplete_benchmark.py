...
# 解决 Exception: Failed to find semgrep-core in PATH or in the semgrep package.
import os
os.environ["SEMGREP_BINARY_PATH"] = r"E:\self-cultivation\Python\AI_Security\openai_1.3.6\Scripts\semgrep.exe"
