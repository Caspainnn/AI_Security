...
parser.add_argument(
    '--image-path', type=str,
    default='./data/watermark-unavailable/watermarked/watermarked3.jpg',
    help='Path to the "watermarked" image.'
)
parser.add_argument(
    '--mask-path', type=str,
    default='./data/watermark-unavailable/masks/mask3.png',
    help='Path to the "watermark" image.'
)
parser.add_argument(
    '--input-depth', type=int, default=32,
...
parser.add_argument(
    '--training-steps', type=int, default=3000,
    help='Number of training iterations.'
)
parser.add_argument(
    '--show-step', type=int, default=200,
    help='Interval for visualizing results.'
)
parser.add_argument(
    '--reg-noise', type=float, default=0.03,
    help='Hyper-parameter for regularized noise input.'
)
parser.add_argument(
    '--max-dim', type=int, default=512,
    help='Max dimension of the final output image'
)
