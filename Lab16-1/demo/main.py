# -*- coding: utf-8 -*-
"""
This module is intended to join all the pipeline in separated tasks to be executed individually or in a flow by using command-line options
...
def process_task(stopping):
    ...
    model = process.demo(
        ...
        device=DEVICE,
        model=demo.model,
        learning_rate=demo.learning_rate,
        weight_decay=demo.weight_decay,
        loss_lambda=demo.loss_lambda
    )
